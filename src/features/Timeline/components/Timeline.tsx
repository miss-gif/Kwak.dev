  ...
  return (
    <Timeline>
      ...
      <TimeItem
        ...
        year=""
        label="인터넷 강의 및 개인 프로젝트 작업"
        text="패캠, 인프런, 유데미 강의를 통해 학습"
      />
      <TimeItem
        color="inherit"
