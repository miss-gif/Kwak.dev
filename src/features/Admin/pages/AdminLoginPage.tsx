  ...
  return (
    <div className="flex h-dvh w-full flex-col items-center justify-center">
      <div className="w-96 rounded-md bg-white p-6">
        <h2 className="mb-4 text-xl font-semibold text-gray-700">관리자 인증</h2>
        <input
          type="password"
        ...
        <button onClick={handleSubmit} className="mt-4 w-full rounded-md bg-blue-500 px-4 py-2 text-white hover:bg-blue-600">
          인증하기
        </button>
      </div>
    </div>
